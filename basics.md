...
这页提供了 Markdown 簡單的概觀給想使用的人， [语法说明][s] 页提供了完整详细的文件，说明每页项功能，但是 Markdown 其实很简单就可以上手，这页文件提供了一些范例，并且每个范例都有提供输出的 HTML 結果。

其实直接试试看也是一个很不错的方法， [Dingus][d] 是一個網頁應用程式，讓你可以把你的 Markdown 文件轉成 XHTML。
